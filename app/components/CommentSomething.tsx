...
export default function CommentSomething() {
    return (
        <form className="flex flex-row gap-3 w-full p-3 bg-slate-100 rounded-md">
            <input type='text' placeholder='Comment something...' className='w-full border p-2 text-sm text-cyan-600 rounded-md border-cyan-500/25 caret-cyan-500 focus:outline-none focus:bg-cyan-50/50'></input>
